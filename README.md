...
functional component or stateless component accept data and display them similarly.
but stateful data can hold on data and can keep record of change in data

2. When does a componentWillMount function be called? What about a componentWillUpdate?

componentWillMount() is used before mounting and before rendering of the page. however its not a safe component accoridng to react and a constructor should be used instead.
componentWillUpdate() takes nextState and nextProps argument and is similar to componentsdidMount().

3. Define stateful logic.

various codes can work under one fucntion that can handle change and work to change sets of data. this can be helpful is making the coding more disinguished and easier to manipulate.

4. What are the three step of creating a successful test? What is done in each phase?

arrange: Setup the react component that are being tested.
Act: Execute behavior (if one exist).
Assert: Extract the response and make sure (if needed) that its work as we intended.
